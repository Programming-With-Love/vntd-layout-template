  ...
  methods: {
    options() {
      var geoCoorddata = {
        ...
        RiodeJaneiro: [-43.172896, -22.906847],
        Rome: [12.496366, 41.902783],
        SantiagodeChile: [-70.669265, -33.44889],
        SaoPaulo: [-46.633309, -23.55052],
      ...
      citys.forEach((city, index, citys) => {
        var temp = Math.floor(Math.random() * citys.length);
        datas.push({
          name: city.name,
